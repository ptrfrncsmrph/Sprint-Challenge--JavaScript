...
const contactInfo = [];
for ({ first_name, email } of graduates) {
...
for (university of universities) {
  /Uni/g.test(university) && uni.push(university)
}
console.log(uni);
...
*/
const animalNames = [];
zooAnimals.forEach(({ animal_name: n, scientific_name: s }) => {
  animalNames.push(`Name: ${n}, Scientific: ${s}`)
})
